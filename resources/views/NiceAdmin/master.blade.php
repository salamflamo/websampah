                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li id="mail_notificatoin_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{URL::asset('nice-assets/./img/avatar-mini.jpg')}}"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{URL::asset('nice-assets/./img/avatar-mini2.jpg')}}"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{URL::asset('nice-assets/./img/avatar-mini3.jpg')}}"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{URL::asset('nice-assets/./img/avatar-mini4.jpg')}}"></span>
                                    <span class="subject">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<table class="table bootstrap-datatable countries">
								...
								<tbody>
									<tr>
										<td><img src="{{URL::asset('nice-assets/img/Germany.png')}}" style="height:18px; margin-top:-2px;"></td>
										<td>Germany</td>
										<td>2563</td>
										<td>1025</td>
										<td>
									...
									<tr>
										<td><img src="{{URL::asset('nice-assets/img/India.png')}}" style="height:18px; margin-top:-2px;"></td>
										<td>India</td>
										<td>3652</td>
										<td>2563</td>
										<td>
									...
									<tr>
										<td><img src="{{URL::asset('nice-assets/img/Spain.png')}}" style="height:18px; margin-top:-2px;"></td>
										<td>Spain</td>
										<td>562</td>
										<td>452</td>
										<td>
									...
									<tr>
										<td><img src="{{URL::asset('img/India.png')}}" style="height:18px; margin-top:-2px;"></td>
										<td>Russia</td>
										<td>1258</td>
										<td>958</td>
										<td>
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-4">
                                <span class="profile-ava pull-right">
                                        <img alt="" class="simple" src="{{URL::asset('nice-assets/img/avatar1_small.jpg')}}">
                                        Jenifer smith
                                </span>                                
                              </div>
                            </div>
